    ...
    <Layout noHero>
      <SEO title="OSS by Zenika" keywords={[`gatsby`, `application`, `react`]} />
        <article className="terms__body">
          ...
          <p>
          Hébergement : Netlify © 2019
          </p>
          <h2><strong>Propriété Intellectuelle</strong></h2>


          <p>
          La structure générale, les textes, images animées ou non, les savoir-faire, les programmes et logiciels ainsi que tout autre élément composant ce site sont la propriété exclusive de Zenika et sont protégés par le droit d’auteur. Toute représentation totale ou partielle de ce site, par quelque procédé que ce soit, sans l’autorisation expresse de Zenika est donc interdite et constituerait une contrefaçon. Il en est de même des bases de données figurant sur le site training.zenika.com qui sont protégées.
          </p>
          <p>
          ...
          <p>
          Il accepte les présentes conditions d’utilisation. Tout litige portant sur l’interprétation ou l’exécution des présentes mentions sera de la compétence exclusive des tribunaux français faisant l’application de la loi française. L’ensemble des éléments de ce site est protégé par copyright Zenika.
          </p>
          ...
          <table>
            <tr>
             ...
             <td><strong>Fournisseur</strong>
             </td>
             <td><strong>Finalité</strong>
             </td>
            ...
            <tr>
             ...
             <td>Enregistre un identifiant unique utilisé pour générer des données statistiques sur la façon dont l e visiteur utilise le site
             </td>
             <td>2 années
             </td>
             <td>HTTP Cookie
            ...
            <tr>
             ...
             <td>Stocke l'autorisation d'utilisation de cookies pour le domaine actuel par l'utilisateur
             </td>
             <td>1 année
             </td>
             <td>HTTP Cookie
          ...
          <p>
          Lorsque vous nous fournissez vos données afin d’être recontacté par nos services, celles-ci sont traitées uniquement par le personnel interne et habilité de Zenika et ne font l’objet d’aucune transmission à des tiers extérieurs.
          </p>
          <p>
          ...
          <p>
          Si vous estimez après nous avoir contactés que vos droits ne sont pas respectés, vous pourrez à tout moment saisir l’<a href="https://www.cnil.fr/">autorité de contrôle</a>.
          </p>
          <p>
