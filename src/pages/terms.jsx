    ...
    <article className="terms__body">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            Enregistre un identifiant unique utilisé pour générer des données statistiques sur la façon dont l e visiteur utilise le site
          </td>
          <td>
            2 années
          </td>
      ...
      <p>
        Si vous estimez après nous avoir contactés que vos droits ne sont pas respectés, vous pourrez à tout moment saisir l’
