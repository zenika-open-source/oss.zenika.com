  ...
  <article className="resources">
    ...
    <div className="resources__content">
      <div className="resources__links">
        <a href="https://opensource.dev" target="NEW">
          opensource.dev
        </a>
        <a href="https://opensource.guide" target="NEW">
          opensource.guide
        </a>
        <a href="https://todogroup.org/guides/" target="NEW">
          todogroup.org/guides/
        </a>
        <a href="https://opensource.org/" target="NEW">
          opensource.org/
        </a>
      </div>
